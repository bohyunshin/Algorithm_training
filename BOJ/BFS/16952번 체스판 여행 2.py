...
visited = [[[[Piece(-1,1e100) for _ in range(3)] for _ in range(n*n)] for _ in range(n)] for _ in range(n)]
        ...
        for i in range(8):
            ...
            if 0 <= nx < n and 0 <= ny < n:
                ...
                if visited[nx][ny][next_num][horse].dist == -1 or \
                    ...
                    visited[nx][ny][next_num][horse].change = c
